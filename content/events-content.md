...
events:
  ...
  - title: 'Workshop sobre Aquicultura em Angola'
    ...
    image: 'event-workshop-aquicultura'
    description: 'O Workshop sobre Aquicultura em Angola é uma iniciativa de grande relevância promovida pelo Ministério das Pescas e Recursos Marinhos, em parceria com a Associação Nacional de Aquicultores (ANAQUI) e o Governo Provincial de Luanda.'
    fullDescription:
      - 'O Workshop sobre Aquicultura em Angola é uma iniciativa de grande relevância promovida pelo Ministério das Pescas e Recursos Marinhos, em parceria com a Associação Nacional de Aquicultores (ANAQUI) e o Governo Provincial de Luanda.'
      - 'Com o tema “O papel da aquicultura no desenvolvimento sustentável e segurança alimentar em Angola”, o evento irá reunir especialistas, profissionais do setor, académicos e membros da Ordem ligados à aquicultura, para debater os desafios e oportunidades deste segmento estratégico para a economia e segurança alimentar do país.'
      - 'A realização deste workshop nasce da necessidade de fortalecer o diálogo técnico e científico sobre a aquicultura, criando um espaço de reflexão sobre políticas públicas, inovação tecnológica e práticas sustentáveis que garantam maior produtividade, conservação dos recursos e geração de empregos.'
      - 'Um encontro imperdível para todos os que acreditam no potencial transformador da aquicultura em Angola.'

  - title: 'Workshop sobre Bovinocultura – Huambo'
    id: 'workshop-bovinocultura-huambo'
    date: 'Huambo — 26 e 27 de Setembro de 2025'
    image: 'event-workshop-bovinocultura'
    ...
    fullDescription:
      ...
      - 'Este encontro será um espaço de formação, debate e troca de ideias, fortalecendo o papel do médico veterinário como agente essencial na produtividade, sanidade e bem-estar animal.'
      - 'Público-alvo: Médicos Veterinários, Técnicos de Produção Animal, Estudantes e Empresários do Sector Pecuário'
      - 'Participe e faça a diferença no futuro da bovinocultura angolana.'
---
